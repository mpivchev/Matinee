...
class Keywords_DELETE {
  ...
  factory Keywords_DELETE.fromJson(Map<String, dynamic> json) => new Keywords_DELETE(
    keywords: new List<Genre>.from(json["keywords"].map((x) => Genre.fromJson(x))),
  );
