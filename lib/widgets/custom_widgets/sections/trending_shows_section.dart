...
import 'package:movie_finder/bloc/tmdb/tmdb_show_bloc.dart';
...
class TrendingShowsSection extends StatefulWidget {
  @override
  _TrendingShowsSectionState createState() => _TrendingShowsSectionState();
}

class _TrendingShowsSectionState extends State<TrendingShowsSection> {
  final _blocShows = TmdbShowBloc();

  @override
  void initState() {
    _blocShows.dispatch(FetchTrendingShows());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      child: BlocBuilder(
        bloc: _blocShows,
        builder: (BuildContext context, TmdbShowState state) {
          if (state is TrendingShowsLoaded) {
            final shows = state.list;
